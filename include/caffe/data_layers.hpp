...
*/
    ...
    public:
        ...
        //virtual void InternalThreadEntry() {LOG(INFO)<<"should not be here!";}
        // Prefetches batches (asynchronously if to GPU memory)
        //static const int PREFETCH_COUNT = 3;
...
BlockingQueue<Batch<Dtype>*> prefetch_full_;*/
    ...
    template <typename Dtype>
    class ImageColorizationDataLayer : public ImageDimPrefetchingDataLayer<Dtype> {
    public:
        explicit ImageColorizationDataLayer(const LayerParameter& param)
        : ImageDimPrefetchingDataLayer<Dtype>(param) {}
        virtual ~ImageColorizationDataLayer();
        virtual void DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
        const vector<Blob<Dtype>*>& top);
